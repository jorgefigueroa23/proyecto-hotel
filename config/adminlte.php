...
return [
    ...
    */
    'logo' => '
        <div class="d-flex align-items-center">
            <img src="vendor/adminlte/dist/img/Logo.png" alt="HS Ready Logo" class="brand-image img-circle elevation-3" style="height:35px; width:auto;">
            <span class="brand-text font-weight-light ml-2"><b>HS</b>Ready</span>
        </div>
    ',
    'logo_img' => null, // Desactiva el logo automático, ya lo incluimos manualmente arriba
    'logo_img_class' => '',
    'logo_img_xl' => null,
    'logo_img_xl_class' => '',
    'logo_img_alt' => '',
    ...
    */
    ...
    'menu' => [
        ...
        /* [
            'text' => 'ESTADO DE PAGO',
            'url'  => 'procesos/show-pagos',
        ], */
        /* [
            'text' => 'DISPONIBLES',
            'url'  => 'procesos/tumbasDisponibles',
        ], */
